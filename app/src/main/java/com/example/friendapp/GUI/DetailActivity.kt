...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (intent.extras!!.get("friend") != null) {
            ...
            /*if (intent.hasExtra("PicUri") != null) {
                savedUri = intent.extras!!.get("PicUri").toString()
                Log.d("abc", "uri" +  savedUri)
            }*/
            ...
            if (selectedFriend.picPath != null) {
                imageView.setImageURI(selectedFriend.picPath!!.toUri())
            }
            /*if (savedUri != "")
                imageView.setImageURI(savedUri.toUri())
            Log.d("abc", "" + friend)
        } else {
        ...
        if (iscreate == true) {
            ...
            if (friendToUpdate != null) {
                ...
                /*if (savedUri != null) {
                    ...
                    Log.d("abc", "selectedfriend.picpath : " + selectedFriend.picPath)
                } else {*/
                    friendToUpdate = BEFriend(
                        id = intent.extras!!.getInt("id"),
                        name = tvName.text.toString(),
                        ...
                        source = tvSource.text.toString(),
                        location = tvLocation.text.toString(),
                        picPath = selectedFriend.picPath
                    )
                    mRep1.update(friendToUpdate)
                    Log.d("abc", "Friend updated" + friendToUpdate)
                    Log.d("abc", "selectedfriend.picpath : " + selectedFriend.picPath)
